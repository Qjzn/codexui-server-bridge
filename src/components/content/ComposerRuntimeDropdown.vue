<template>
  <div class="runtime-toggle" role="radiogroup" aria-label="继续方式">
    <button
...
const options = [
  { value: 'local' as const, label: '当前项目', icon: IconTablerFolder },
  { value: 'worktree' as const, label: '新建工作树', icon: IconTablerGitFork },
]
